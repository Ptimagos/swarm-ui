	...
	<div id="sidebar-wrapper">
		...
		<ul class="sidebar-nav" id="sidebar">     
			<li id="wrapper-hosts_0001" class="active">
				<a onclick='hostsWrapper(1)' href="#" id="hosts_elem_0001" data-toggle="tooltip" data-placement="right" title="Hosts">
					Hosts
					<span id="main_icon" class="glyphicon glyphicon-th-list">
					</span>
				</a>
			</li>
			<li id="wrapper-hosts_0004">
				<a onClick='hostsWrapper(4)' href="#" id="hosts_elem_0003" data-toggle="tooltip" data-placement="right" title="Tasks">
					Tasks
			...
			<li id="wrapper-hosts_0002">
				<a onclick='hostsWrapper(2)' href="#" id="hosts_elem_0002" data-toggle="tooltip" data-placement="right" title="Parameters">
					Parameters
					<span id="main_icon" class="glyphicon glyphicon-cog">
					</span>
				</a>
			</li>
		</ul>
