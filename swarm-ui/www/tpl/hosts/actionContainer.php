<?PHP
	...
	switch ($action) {
		case 'stop':
			$action_id ="Stop container";
			break;
		case 'start':
			$action_id ="Start container";
			break;
	}
	...
	$req="insert into ds_tasks (host_id, job_id, instance_id, options, step_id, action_id, status_id, user_id, progress) "
		. "values ('".$host_id."','".$job_id."','".$instance_id."','".$container_id."','0','".$actions_name[$action_id]."', '3', '".$_SESSION['login_id']."', '0');";
	$resu = execRequete ($req, $connexion);
	$req="insert into ds_tasks (host_id, job_id, instance_id, options, step_id, action_id, status_id, user_id, progress) "
		. "values ('".$host_id."','".$job_id."','".$instance_id."','".$container_id."','1','".$actions_name[$action_id]."', '3', '".$_SESSION['login_id']."', '0');";
	$resu = execRequete ($req, $connexion);

	// Deconnexion de la base de donnees :
	decMysql($connexion);
	print "<h4>Container ".$container_id." ".$action." added to task lists</h4>";
?>