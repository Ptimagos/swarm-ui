<?php
	...
	$req="update ds_tasks set status_id = '8', start_date = '".$date_jobs."', progress = '100' where job_id = '".$job_id."' and action_id = '".$actions_name['Stop container']."';";
	$resu = execRequete ($req, $connexion);
	
	// Execution Pull Docker Image
	$fileout=$server['cfg']['logs'].$hostname.".".$job_id.".log";
	$fileurl="/logs/".$hostname.".".$job_id.".log";
	$role="docker-stop-container";
	...
	if ( $ansiblePlay == 0 ) {
		$ansible_status=$status_name['success'];
		$req="update ds_hosts_instances set status_id = '".$status_name['stopped']."', random = '".rand()."' where host_id = '".$host_id."' and "
	...
	$req="update ds_tasks set status_id = '".$ansible_status."', end_date = '".$date_jobs."', log_file ='".$fileurl."', "
		. "progress = '100' where job_id = '".$job_id."' and action_id = '".$actions_name['Stop container']."'";
	$resu = execRequete ($req, $connexion);
